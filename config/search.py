...
search_terms = ["Bom enginner", "configuration enginner", "Bom management", "Control valves bom configuration", "engineering change and change management", "ECO/ECR", "oil and gas equipment"]
...
experience_level = [2-3]              # (multiple select) "Internship", "Entry level", "Associate", "Mid-Senior level", "Director", "Executive"
...
industry = ["mechanical"]                      # (dynamic multiple select)
